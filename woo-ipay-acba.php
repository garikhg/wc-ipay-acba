...
define( 'IPAY_ACBA_PLUGIN_VERSION', '1.0.0.beta5' );
define( 'IPAY_ACBA_PLUGIN_DIR', dirname( __FILE__ ) );
define( 'IPAY_ACBA_PLUGIN_DIR_URL', plugin_dir_url( __FILE__ ) );
...
function ipay_acba_init_class() {
	...
	require IPAY_ACBA_PLUGIN_DIR . '/inc/class-ipay-acba-gateway.php';
}

add_action( 'plugins_loaded', 'ipay_acba_init_class' );

require IPAY_ACBA_PLUGIN_DIR . '/inc/ipay-acba-helpers.php';
require IPAY_ACBA_PLUGIN_DIR . '/inc/ipay-acba-thankyou.php';
